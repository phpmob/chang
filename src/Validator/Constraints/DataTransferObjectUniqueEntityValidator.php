...
class DataTransferObjectUniqueEntityValidator extends ConstraintValidator
{
     ...
     * @param Constraint|DataTransferObjectUniqueEntity $constraint
     */
    public function validate($value, Constraint $constraint)
    {
        ...
        if (!$value instanceof DataTransferObjectInterface) {
            throw new UnexpectedTypeException($value, DataTransferObjectInterface::class);
        }

        if (!$constraint instanceof DataTransferObjectUniqueEntity) {
            throw new UnexpectedTypeException($constraint, DataTransferObjectUniqueEntity::class);
        }
        ...
        $this->context->buildViolation($constraint->message)
            ...
            ->setCode(DataTransferObjectUniqueEntity::NOT_UNIQUE_ERROR)
            ->setCause($result)
            ->addViolation();
    }
